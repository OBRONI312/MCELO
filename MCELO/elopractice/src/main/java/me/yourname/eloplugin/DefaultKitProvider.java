...
public class DefaultKitProvider {
    ...
    private static ItemStack[] getVanillaKit() {
        ...
        if (mMace != null) {
            applySafeEnchants(mMace, "DENSITY", 5, "DURABILITY", 3, "MENDING", 1);
        ...
        if (mAxe != null) {
            applySafeEnchants(mAxe, "DAMAGE_ALL", 5, "DURABILITY", 3, "MENDING", 1);
        ...
        if (mCross != null) {
            applySafeEnchants(mCross, "QUICK_CHARGE", 3, "DURABILITY", 3, "MENDING", 1, "PIERCING", 4);
        ...
        if (mElytra != null) {
            applySafeEnchants(mElytra, "DURABILITY", 3, "MENDING", 1);
        ...
        if (mBoots != null) {
            applySafeEnchants(mBoots, "PROTECTION_EXPLOSIONS", 4, "DURABILITY", 3, "MENDING", 1, "PROTECTION_FALL", 4, "DEPTH_STRIDER", 3, "SOUL_SPEED", 3);
        ...
        if (mChest != null) {
            applySafeEnchants(mChest, "PROTECTION_ENVIRONMENTAL", 4, "DURABILITY", 3, "MENDING", 1);
        ...
        if (mHelm != null) {
            applySafeEnchants(mHelm, "PROTECTION_ENVIRONMENTAL", 4, "DURABILITY", 3, "MENDING", 1, "OXYGEN", 3, "WATER_WORKER", 1);
    ...
    private static ItemStack[] getUHCKit() {
        ...
        if (pm != null) {
            applySafeEnchants(pm, "DURABILITY", 3);
            pick.setItemMeta(pm);
        }
        items[4] = pick;
