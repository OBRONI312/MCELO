...
Used in this server: https://modrinth.com/server/mcelo-practice-asiaoffline

### If no custom arena is uploaded to the plugin then the plugin will fallback to a default bedrock platform, see how to add a custom arena in the wiki: https://github.com/OBRONI312/MCELO/wiki/How-to-make-a-custom-arena
...
## 🛠 Commands (can also be executed using items)
...
5. **Note:** Use Red Concrete for Player 1 spawn and Blue Concrete for Player 2 spawn inside your schematics.
